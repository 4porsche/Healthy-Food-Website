            ...
            <head>
                ...
                <style>
                    ...
                    .tag-group {
                        ...
                        gap: 8px 24px;
                        /* khoảng cách giữa hàng và giữa 2 cột */
                    }
                                    ...
                                    <div class="col-md-6">
                                        <form action="manage-product" method="POST"
                                            ...
                                            <div class="search-box d-flex">
                                                <input value="${txtS}" type="text" id="searchInput" name="txt"
                                    ...
                                    <div class="col-md-4">
                                        <form action="manage-product" method="POST">
                                            <select name="sort" class="form-control" onchange="this.form.submit()">
                                                ...
                                                <option value="1" ${param.sort==1 ? 'selected' : '' }>Cuốn lành mạnh
                                                </option>
                                                <option value="2" ${param.sort==2 ? 'selected' : '' }>Ít tinh bột
                                                </option>
                                                <option value="3" ${param.sort==3 ? 'selected' : '' }>Thuần chay đặc
                                                    biệt</option>
                                            </select>
                                        </form>
                                    </div>
                                ...
                                <c:forEach var="p" items="${productList}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="manage-product" method="POST"
                                                onsubmit="return confirmDelete(event, '${p.productName}')">
                        ...
                        <div id="popup-add" class="popup">
                            <div class="popup-content">
                                ...
                                <div class="popup-body">
                                    ...
                                    <div class="tag-group">
                                        <label><input type="checkbox" name="tags" value="bún" />
                                            <span>bún</span></label>
                                        <label><input type="checkbox" name="tags" value="bánh tráng" /> <span>bánh
                                                tráng</span></label>
                                        <label><input type="checkbox" name="tags" value="vỏ tortilla" /> <span>vỏ
                                                tortilla</span></label>
                                        <label><input type="checkbox" name="tags" value="yến mạch" /> <span>yến
                                                mạch</span></label>
                                        <label><input type="checkbox" name="tags" value="gà" /> <span>gà</span></label>
                                        <label><input type="checkbox" name="tags" value="hải sản" /> <span>hải
                                                sản</span></label>
                                        <label><input type="checkbox" name="tags" value="trứng" />
                                            <span>trứng</span></label>
                                        <label><input type="checkbox" name="tags" value="hạt" />
                                            <span>hạt</span></label>
                                        <label><input type="checkbox" name="tags" value="nấm" />
                                            <span>nấm</span></label>
                                        <label><input type="checkbox" name="tags" value="đậu hũ" /> <span>đậu
                                                hũ</span></label>
                                        <label><input type="checkbox" name="tags" value="đậu que" /> <span>đậu
                                                que</span></label>
                                        <label><input type="checkbox" name="tags" value="rong biển" /> <span>rong
                                                biển</span></label>
                                        <label><input type="checkbox" name="tags" value="trái cây" /> <span>trái
                                                cây</span></label>
                                    </div>
                                ...
                                <div class="popup-button">
                                    <button type="button" class="btn-cancel"
                                        onclick="closePopup('popup-add')">Hủy</button>
